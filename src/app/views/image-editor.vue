<template>
	<v-drawer v-model="internalActive" class="modal" :title="t('editing_image')" persistent
		...
		<div v-show="imageData && !loading && !error" class="editor-container">
			...
			<div class="toolbar">
				<div v-tooltip.top.inverted="t('drag_mode')" class="drag-mode toolbar-button"
				...
				<v-icon v-tooltip.top.inverted="t('flip_horizontal')" name="flip_horizontal" clickable
					@click="flip('horizontal')" />

				<v-icon v-tooltip.top.inverted="t('flip_vertical')" name="flip_vertical" clickable
					@click="flip('vertical')" />

				<v-menu placement="top" show-arrow>
					<template #activator="{ toggle }">
						<v-icon v-tooltip.top.inverted="t('aspect_ratio')" :name="aspectRatioIcon" clickable
							@click="toggle" />
					</template>

					<v-list>
						<template v-if="customAspectRatios">
							<v-list-item v-for="customAspectRatio in customAspectRatios" :key="customAspectRatio.text"
								clickable :active="aspectRatio === customAspectRatio.value"
						...
						<v-list-item v-if="imageData" clickable
							:active="aspectRatio === imageData.width / imageData.height" @click="setAspectRatio">
							<v-list-item-icon>
